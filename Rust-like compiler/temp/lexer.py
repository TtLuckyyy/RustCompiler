...
class Tokenize:
    ...
    def _process_identifier(self):
        ...
        return LexicalElement(lexical_type, identifier if lexical_type == LexicalType.IDENTIFIER else None, start_row, start_col)
...
#     with open("./test/6_1.rs", 'r', encoding='utf-8') as f:
#         tokens = Tokenize().analyse(f.read())